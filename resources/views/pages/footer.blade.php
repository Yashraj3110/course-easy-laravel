    <footer class="bg-slate-800 dark:bg-gray-900 text-slate-400 dark:text-gray-300 py-12">
            ...
            <div class="flex flex-col md:flex-row justify-between items-center text-center md:text-left">
                ...
                <div class="flex flex-wrap justify-center md:justify-start space-x-6">
                    ...
                    <a href="#" class="hover:text-white dark:hover:text-indigo-400 transition-colors">Terms of
                        Service</a>
                    <a href="#" class="hover:text-white dark:hover:text-indigo-400 transition-colors">Contact</a>
                </div>
            </div>
        </div>
    </footer>
